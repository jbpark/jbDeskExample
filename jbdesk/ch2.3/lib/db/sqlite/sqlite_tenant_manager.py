...
from lib.db.sqlite.sqlite_connect_info import get_sqlite_connect_info, SQLITE_CONNECTION_KEYS
from lib.db.sqlite.sqlite_manager import SqliteManager

logging.basicConfig(level=logging.DEBUG)


class SqliteTenantManager(SqliteManager):
    ...
    def __init__(self, yaml_loader, env_type, db_type, vendor):
        ...
        self.connect_info = get_sqlite_connect_info(self.yaml_loader, self.config_section)
