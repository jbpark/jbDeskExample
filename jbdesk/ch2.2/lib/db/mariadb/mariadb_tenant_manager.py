...
from lib.db.mariadb.mariadb_connect_info import get_mariadb_connect_info, MARIADB_CONNECTION_KEYS
from lib.db.mariadb.mariadb_manager import MariadbManager
from lib.models.constants.const_config import ConfigKey
from lib.db.oracle.oracle_connect_info import get_oracle_connect_info, ORACLE_CONNECTION_KEYS
from lib.db.oracle.oracle_manager import OracleManager
from lib.models.constants.const_db_vendor import DB_VENDOR_ORACLE

logging.basicConfig(level=logging.DEBUG)


class MariadbTenantManager(MariadbManager):
    ...
    def __init__(self, yaml_loader, env_type, db_type, vendor):
        ...
        self.connect_info = get_mariadb_connect_info(self.yaml_loader, self.config_section)
